...
class ScriptAgent(BaseAgent):
    ...
    def handle(self, task):
        ...
        if task.type == "write_scripts":
            ...
            self.telegram.send(f"✅ ScriptAgent: 3 scripts written!")
            return result